...
//İ Copyright (c) 1996-2012 Image Space Incorporated.  All rights reserved. Ş
//İ                                                                         Ş
//İ Change history:                                                         Ş
...
struct MessageInfoV01
{
  ...
  unsigned char mExpansion[127]; // for future use (possibly what color, what font, whether to attempt translation, and seconds to display)
};
...
struct VehicleScoringInfoV01
{
  ...
  // Future use
  // tag.2012.03.01 - SEE ABOVE!
  unsigned char mExpansion[80];  // for future use
};
